...
%                    <esling@ircam.fr>
%
function orderListID = getTemporalQueryExact(connecDB, descValue, descName, soundID, maxN)
...
str2 = invertScaleRepresentation(descStr, 20, mean(descValue), max(abs(descValue)));
...
for i = 1:size(dValue, 1)
    dataValue = invertScaleRepresentation(dValue{i, 2}, 20, dValue{i, 3}, dValue{i, 4});
