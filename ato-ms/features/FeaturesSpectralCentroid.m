%
% FeaturesSpectralCentroid.m     : Definition of spectral centroid
%
...
% Version           : 1.0
%
classdef FeaturesSpectralCentroid < Features
    
    methods
        
        %
        % Main constructor for spectral centroid feature
        %
        function fI = FeaturesSpectralCentroid(sessObj, name)
        ...
        function fDistance = compare(this, soundsetFeatures, targetFeatures)
            str2 = targetFeatures.SpectralCentroid.';
            soundsetMat = soundsetFeatures.SpectralCentroid;
