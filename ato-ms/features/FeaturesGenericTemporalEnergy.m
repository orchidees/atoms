...
% Version           : 1.0
%
classdef FeaturesGenericTemporalEnergy < Features
	...
	methods
        ...
        %
        function fI = FeaturesGenericTemporalEnergy(sessObj, name)
        ...
        function sFeatures = addition(this, population)
            ...
            for i = 1:size(sFeatures, 1)
                ...
                temporalMatrix = sum(descriptor, 2);
