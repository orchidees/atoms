{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 98.0, 100.0, 443.0, 588.0 ],
		"bglocked" : 0,
		"defrect" : [ 98.0, 100.0, 443.0, 588.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "/getsearchalgorithms 44",
					"numinlets" : 2,
					"patching_rect" : [ 52.0, 74.0, 139.0, 18.0 ],
					"numoutlets" : 1,
					"id" : "obj-11",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "route 44",
					"numinlets" : 1,
					"patching_rect" : [ 52.0, 243.0, 44.0, 17.0 ],
					"numoutlets" : 2,
					"id" : "obj-15",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"patching_rect" : [ 52.0, 198.0, 83.0, 17.0 ],
					"numoutlets" : 1,
					"id" : "obj-16",
					"fontname" : "Arial",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "route /searchalgorithms",
					"numinlets" : 1,
					"patching_rect" : [ 52.0, 220.0, 105.0, 17.0 ],
					"numoutlets" : 2,
					"id" : "obj-17",
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
...
, 			{
				"box" : 				{
					...
					"text" : "s serversend",
					"numinlets" : 1,
					"patching_rect" : [ 52.0, 104.0, 69.0, 17.0 ],
					"numoutlets" : 0,
					"id" : "obj-18",
					"fontname" : "Arial",
					"fontsize" : 9.0
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-3", 0 ],
					"hidden" : 0,
					"midpoints" : [ 136.5, 442.0, 60.5, 442.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 61.5, 309.0, 188.5, 309.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-9", 0 ],
					"hidden" : 0,
					"midpoints" : [ 61.5, 309.0, 104.5, 309.0 ]
				}
